...
class SampleDataAnalytics:
    ...
    def _get_top_failure_reasons(self, orders_df: pd.DataFrame, failed_orders: int) -> List[Dict[str, Any]]:
        """Get top failure reasons with percentages"""
    ...
    def get_failure_analysis(self) -> Dict[str, Any]:
        ...
        # Time patterns
        time_patterns = self._get_time_patterns(orders_df)
        
        # Day patterns
        day_patterns = self._get_day_patterns(orders_df)
        
        # Location patterns
        location_patterns = self._get_location_patterns(orders_df)
        
        # External factors correlation
        external_factors = self._get_external_factors_correlation()
